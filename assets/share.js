// orange-wks/portal — share buttons
// og:url, og:title メタタグから自動生成
(function () {
  ...
  var html =
    ...
    '<a class="share-btn" href="https://twitter.com/intent/tweet?url=' + eu + '&text=' + et + '" target="_blank" rel="noopener" title="X">' +
    '<svg viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>' +
    '</a>' +
    '<a class="share-btn" href="https://b.hatena.ne.jp/add?mode=confirm&url=' + eu + '&title=' + et + '" target="_blank" rel="noopener" title="はてなブックマーク">' +
    ...
    '</a>' +
    '<a class="share-btn" href="https://social-plugins.line.me/lineit/share?url=' + eu + '" target="_blank" rel="noopener" title="LINE">' +
    ...
    '</a>' +
    '<button class="share-btn" title="リンクをコピー">' +
  ...
  // 挿入先を探す: .article-body の末尾、または footer の直前
  var target = document.querySelector('.article-body') || document.querySelector('footer');
  if (!target) return;

  var container = document.createElement('div');
  container.innerHTML = html;
  var shareDiv = container.firstChild;

  if (target.classList.contains('article-body')) {
    target.appendChild(shareDiv);
  } else {
    target.parentNode.insertBefore(shareDiv, target);
  }

  // コピーボタン
  var copyBtn = shareDiv.querySelector('button');
  if (copyBtn) {
